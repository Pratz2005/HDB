          ...
          <div className="flex justify-between items-center py-4">
            <Link href="/dashboard">
              <div className="flex items-center">
                <Image src="/logo.png" alt="Smart HDB Finder" width={120} height={80} className="cursor-pointer" />
              </div>
            </Link>
            <Link href="/dashboard">
              <button className="flex items-center text-gray-600 hover:text-orange-500 transition">
