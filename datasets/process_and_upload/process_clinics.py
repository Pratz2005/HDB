...
for feature in geojson_data["features"]:
    ...
    doc_data = {
        ...
        "POSTAL_CD": fix_postal_code(data.get("POSTAL_CD", "")),
        "geopoint": geo_point,
        "geohash": geohash_val
    }
    converted_features.append(doc_data)

# For example, write each document to a Firestore collection:
collection_ref = db.collection("clinic_locations")
