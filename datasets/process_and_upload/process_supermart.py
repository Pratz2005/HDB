...
file_path = "SupermarketsGEOJSON.geojson"
...
for feature in geojson_data["features"]:
    # Parse the Description HTML to extract the table fields
    ...
    doc_data = {
        ...
        "POSTAL_CD": fix_postal_code(data.get("POSTCODE", "")),
        "geopoint": geo_point,
        "geohash": geohash_val
    }
    converted_features.append(doc_data)

# Write each document to a Firestore collection called "supermarket_locations"
collection_ref = db.collection("supermarket_locations")
